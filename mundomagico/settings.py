"""
Django settings for mundomagico project.
...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', 'django-insecure-91!#kbv*#v(esf=^y8pp!v*$&)i1&!1n#+7om5(j!7-ljvu@5g')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'loja.context_processors.empresa',
            ],
        },
    },
]

WSGI_APPLICATION = 'mundomagico.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

# SQLite local por padrão. Em produção, defina DATABASE_URL (ex.: PostgreSQL)
# e instale dj-database-url para usar a linha comentada abaixo.
DATABASES = {
    'default': {
